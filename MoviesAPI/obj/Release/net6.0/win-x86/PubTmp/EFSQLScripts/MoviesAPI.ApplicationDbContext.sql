...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220324142423_Initial')
BEGIN
    CREATE TABLE [Actors] (
...
BEGIN
    ...
    VALUES (N'20220324142423_Initial', N'6.0.0-preview.6.21352.1');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220327135218_IdentityTables')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20220327135218_IdentityTables', N'6.0.0-preview.6.21352.1');
END;
GO
